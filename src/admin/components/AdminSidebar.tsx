...
export const AdminSidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle, user }) => {
    ...
    <div className={`bg-white border-r border-gray-200 transition-all duration-300 ease-in-out h-18 ${
      ...
      {!isCollapsed && (
        <div className="p-4 border-t border-gray-200">
          {user && (<div className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
